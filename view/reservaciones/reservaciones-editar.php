...
<form id="frm-alumno" action="?c=Reservacion&a=Guardar&id_reservacion=<?php echo $reservaciones->id_reservacion; ?>" method="post" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" name="num_mesa" value="<?php echo $reservaciones->num_mesa; ?>" class="form-control" placeholder="Ingrese su apellido" data-validacion-tipo="requerido|min:10" />
    </div>
    ...
    <div class="form-group">
        ...
        <input type="time" name="hora_reservacion" value="<?php echo $reservaciones->hora_reservacion; ?>" class="form-control" placeholder="Ingrese su correo electrónico" data-validacion-tipo="requerido|email" />
    </div>

    <div class="form-group">
        <label>Hora de Registro</label>
        <input type="time" name="hora_registro" value="<?php echo $reservaciones->hora_registro; ?>" class="form-control" placeholder="Ingrese su correo electrónico" data-validacion-tipo="requerido|email" />
    </div>
